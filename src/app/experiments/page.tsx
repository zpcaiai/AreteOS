  ...
  return (
    <div>
      ...
      <Card title={t("innov.exp.newCard")}>
        <input value={hypothesis} onChange={(e) => setHypothesis(e.target.value)} placeholder={t("innov.exp.hypPlaceholder")} className="w-full rounded-lg border border-slate-700 bg-slate-950/50 p-2 text-sm text-slate-200" />
        <input value={metric} onChange={(e) => setMetric(e.target.value)} placeholder={t("innov.exp.metricPlaceholder")} className="mt-2 w-full rounded-lg border border-slate-700 bg-slate-950/50 p-2 text-sm text-slate-200" />
