  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-3">
        <Card title="Global Child Development Score">
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
        ...
        <Card title="Projects in Progress">
      ...
      {env && (
        <Card title="Learning Environment (Parent)">
