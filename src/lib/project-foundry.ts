// Project Foundry service. It turns selected capabilities into a deliberately
// constrained build brief; it does not pretend that selecting a feature creates
// a finished product. The resulting blueprint is the hand-off contract for the
...
function uniqueKnown(ids: string[]) {
