...
const GROUPS: { title: string; titleKey?: DictKey; items: { href: string; label: string; labelKey?: DictKey }[] }[] = [
  { title: "", items: [
    ...
    { href: "/onboarding", label: "First Run · Full Loop" },
    { href: "/journey", label: "Journey · Mission Control" },
  ...
  { title: "Innovation", titleKey: "nav.innovation", items: [
    { href: "/council", label: "Mentor Council" },
    { href: "/future-self", label: "Future Self · Monte Carlo" },
    { href: "/narrative", label: "Growth Narrative" },
    { href: "/evidence", label: "Evidence · Gap" },
    { href: "/experiments", label: "N-of-1 Experiments" },
    { href: "/graph", label: "Knowledge Graph" },
    { href: "/account", label: "Account · Trust" },
  ]},
  { title: "Diagnose & Decide", items: [
    { href: "/growth-protocol", label: "Growth Protocol" },
    { href: "/bottlenecks", label: "Bottleneck Diagnosis" },
    { href: "/prescriptions", label: "Growth Prescription" },
    { href: "/boardroom", label: "Personal Boardroom" },
  ]},
  { title: "Identity & Life OS", items: [
    { href: "/personal-os", label: "Personal OS Compiler" },
    { href: "/specific-knowledge", label: "Specific Knowledge ★" },
    { href: "/deep-work", label: "Deep Work ★" },
    { href: "/identity-tree", label: "Identity Evolution Tree" },
    { href: "/assets", label: "Asset-Based Growth" },
    { href: "/life-capital", label: "Life Capital Ledger" },
  ]},
  { title: "Skills Library", items: [
    { href: "/skills/specific-knowledge", label: "Specific Knowledge" },
    { href: "/skills/deep-work", label: "Deep Work" },
    { href: "/skills/deliberate-practice", label: "Deliberate Practice" },
    { href: "/skills/flow-state", label: "Flow State" },
    { href: "/skills/cognitive-bias", label: "Cognitive Bias" },
    { href: "/skills/double-loop-learning", label: "Double-Loop Learning" },
    { href: "/skills/principle-centered-life", label: "Principle-Centered Life" },
    { href: "/skills/archetype-identity", label: "Archetype Identity" },
    { href: "/skills/intrinsic-motivation", label: "Intrinsic Motivation" },
    { href: "/skills/antifragile-life", label: "Antifragile Life" },
    { href: "/skills/growth-mindset", label: "Growth Mindset" },
    { href: "/skills/behavior-design", label: "Behavior Design" },
    { href: "/skills/identity-based-habit", label: "Identity-Based Habit" },
    { href: "/skills/experiential-learning", label: "Experiential Learning" },
    { href: "/skills/ooda-adaptive-action", label: "OODA Adaptive Action" },
    { href: "/skills/design-thinking", label: "Design Thinking" },
    { href: "/skills/creativity-capability", label: "Creativity Capability" },
    { href: "/skills/mastery-learning", label: "Mastery Learning" },
    { href: "/skills/learning-organization", label: "Learning Organization" },
    { href: "/skills/psychological-safety", label: "Psychological Safety" },
  ]},
