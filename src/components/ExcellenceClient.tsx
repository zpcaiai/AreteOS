  ...
  return (
    <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4">
      ...
      <div className="grid gap-2 sm:grid-cols-2">
        ...
        <input className="rounded-lg border border-slate-700 bg-slate-800 px-3 py-2 text-sm" placeholder={tx("Strengths")} value={f.strengths} onChange={(e) => set("strengths", e.target.value)} />
        <input className="rounded-lg border border-slate-700 bg-slate-800 px-3 py-2 text-sm" placeholder={tx("Weaknesses")} value={f.weaknesses} onChange={(e) => set("weaknesses", e.target.value)} />
      </div>
